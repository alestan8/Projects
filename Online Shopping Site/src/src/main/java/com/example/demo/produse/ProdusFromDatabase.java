...
public class ProdusFromDatabase {
    ...
    public void updateProdus(Produs produs) throws SQLException {
        Connection con= DriverManager.getConnection(url);
        String sql="UPDATE products SET category=\""+produs.getCategory()+"\", subcategory=\""+produs.getSubcategory()+"\", country=\""+produs.getCountry()+"\", description=\""+produs.getDescription()+"\", image1=\""+produs.getImage1()+"\", image2=\""+produs.getImage2()+"\", image3=\""+produs.getImage3()+"\", price="+produs.getPrice()+", quantity="+produs.getQuantity()+", specification=\""+produs.getSpecification()+"\" WHERE name=\""+produs.getName()+ "\" and provider=\""+produs.getProvider()+"\" ";
    ...
    public void insertProdus(Produs produs) throws SQLException{
        Connection con= DriverManager.getConnection(url);
        String sql="INSERT INTO products(category,country,description,image1,image2,image3,name,price,provider,quantity,specification,subcategory) VALUES(\""+produs.getCategory()+"\",\""+produs.getCountry()+"\",\""+produs.getDescription()+"\",\""+produs.getImage1()+"\",\""+produs.getImage2()+"\",\""+produs.getImage3()+"\",\""+produs.getName()+"\","+produs.getPrice()+",\""+produs.getProvider()+"\","+produs.getQuantity()+",\""+produs.getSpecification()+"\",\""+produs.getSubcategory()+"\") ";
        Statement pst=con.prepareStatement(sql);
        boolean rs=pst.execute(sql);
        pst.close();
        con.close();
